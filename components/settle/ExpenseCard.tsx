...
import ExpenseDeleteModal from './modals/ExpenseDeleteModal';
    ...
    return (
        <div className="flex gap-4 relative">
            ...
            <div className="flex-1 pb-4 min-w-0 relative group">
                {/* Delete Background */}
                <div className="absolute top-0 bottom-4 left-0 w-full bg-red-500 rounded-2xl flex items-center justify-start px-6 transform scale-[0.98]">
